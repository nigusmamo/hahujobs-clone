<template>
  <nav
    class="fixed top-0 flex justify-between items-center w-screen h-20 py-4 px-20 z-[9999] backdrop-blur-md sticky"
  >
    ...
    <div class="space-x-4">
      ...
      <button
        class="bg-gradient-to-r from-teal-800 to-teal-600 px-6 py-2 text-white rounded-md text-xs font-bold"
      >
        Login
      </button>
      <span class="text-xs font-bold">Or</span>
      <button
        class="bg-gradient-to-r from-teal-800 to-teal-600 px-4 py-2 text-white rounded-md text-xs font-bold"
      >
        Sign Up
      </button>
    </div>
